...
<%--                    facebook--%>
                    <c:choose>
                        <c:when test="${customer.getFbId() == null}">
                            <a href="https://www.facebook.com/dialog/oauth?client_id=512141757136187&redirect_uri=http://localhost:8081/chiken_war_exploded/fb-login" class="social-button" id="facebook-connect"> <span>Connect with Facebook</span></a>
                        </c:when>
                        <c:when test="${customer.getFbId() != null}">
