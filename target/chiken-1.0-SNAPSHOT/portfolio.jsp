            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    ...
                    <p style="display:inline-flex">
                        <input type="text" name="name" class="form-control" id="search" placeholder="Search" required style="width: 300px;margin-left: auto;
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-${product.getCategoryCode()}">
                            <div class="portfolio-wrap">
                                ...
                                <div class="portfolio-info">
                                    ...
                                    <p>$${product.getProductPrice()}/piece</p>
