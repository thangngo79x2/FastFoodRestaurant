        ...
        <div class="container" data-aos="fade-up" style="background-color: transparent;">
            ...
            <div class="container" style="background-color: orange;">
                <table id="cart" class="table table-hover table-condensed">
                    ...
                    <tfoot>
                    <tr class="visible-xs">
                        <td class="text-center"><strong>Total bill</strong>
                        </td>
                    </tr>
                    <tr>
                        <td><a href="portfolio" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue shopping</a>
                        </td>
                        <td colspan="2" class="hidden-xs"> </td>
                        <td class="hidden-xs text-center"><strong>Total amount ${cart.getSumTotalFormat()}</strong>
                        </td>
                        <td><a href="check-out" class="btn btn-success btn-block">Pay <i class="fa fa-angle-right"></i></a>
                        </td>
                    </tr>
                    </tfoot>
                </table>
