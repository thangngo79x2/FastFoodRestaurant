...
public class FbLogin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (action.equals("siginOrSigup")){
            if (customer == null) {
                ...
                if (code == null || code.isEmpty()) {
                    ...
                    if (getCustomer == null){
                        ...
                        url = "/login.jsp";
                        status = "This Facebook account is not registered";
                    }else {
                        //thủ tục đăng nhập
                ...
                if (code == null || code.isEmpty()) {
                    ...
                    url = "/infor.jsp";
                    status = "Added quick login with Facebook successfully";
                }
            }
            ...
            url = "/infor.jsp";
            status = "Removed quick login with Facebook successfully";
