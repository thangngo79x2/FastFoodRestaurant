    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (action.equals("confirm")) {
            ...
            if (auhCode == null || auhCode.equals("")) {
                url = "/confirm.jsp";
                status = "System error, please enter back to registration step";
            } else if (code == null || code.equals("")) {
                status = "Please enter code";
                url = "/confirm.jsp";
            } else if (!code.equals(auhCode)) {
                status = "you entered the wrong code";
                url = "/confirm.jsp";
            } else {
                //xác nhận đúng
                //lưu xuống database
                ...
                if (user == null) {
                    status = "user not found error on session";
                    url = "/confirm.jsp";
                } else {
